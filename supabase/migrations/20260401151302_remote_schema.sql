...
CREATE OR REPLACE FUNCTION "public"."delete_restaurant_admin"("p_restaurant_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."delete_restaurant_admin"("p_restaurant_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."reset_database_admin"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    admin_id uuid;
...
ALTER FUNCTION "public"."reset_database_admin"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."save_custom_menu_dishes"("p_menu_id" "uuid", "p_dish_ids_to_add" "uuid"[], "p_dish_ids_to_remove" "uuid"[]) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."save_custom_menu_dishes"("p_menu_id" "uuid", "p_dish_ids_to_add" "uuid"[], "p_dish_ids_to_remove" "uuid"[]) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."archived_order_items" (
    ...
    CONSTRAINT "archived_order_items_status_check" CHECK (("status" = ANY (ARRAY['PENDING'::"text", 'IN_PREPARATION'::"text", 'READY'::"text", 'SERVED'::"text", 'DELIVERED'::"text", 'PAID'::"text", 'CANCELLED'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."dishes" (
    ...
    "short_code" "text",
    "ayce_max_orders_per_person" integer,
...
CREATE TABLE IF NOT EXISTS "public"."order_items" (
    ...
    "ready_at" timestamp with time zone,
    CONSTRAINT "chk_order_items_quantity" CHECK (("quantity" > 0)),
    CONSTRAINT "order_items_status_check" CHECK (("status" = ANY (ARRAY['PENDING'::"text", 'IN_PREPARATION'::"text", 'READY'::"text", 'SERVED'::"text", 'DELIVERED'::"text", 'PAID'::"text", 'CANCELLED'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."restaurants" (
    ...
    "enable_course_suggestions" boolean DEFAULT false,
    "analytics_password_hash" "text"
);
...
ALTER TABLE ONLY "public"."subscription_payments"
    ADD CONSTRAINT "subscription_payments_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE SET NULL;
...
CREATE POLICY "custom_menu_dishes_delete_staff" ON "public"."custom_menu_dishes" FOR DELETE USING (true);



CREATE POLICY "custom_menu_dishes_modify_staff" ON "public"."custom_menu_dishes" FOR INSERT WITH CHECK (true);



CREATE POLICY "custom_menu_dishes_select" ON "public"."custom_menu_dishes" FOR SELECT USING (true);



CREATE POLICY "custom_menu_dishes_update_staff" ON "public"."custom_menu_dishes" FOR UPDATE USING (true);
...
GRANT ALL ON FUNCTION "public"."delete_restaurant_admin"("p_restaurant_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."delete_restaurant_admin"("p_restaurant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_restaurant_admin"("p_restaurant_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."reset_database_admin"() TO "anon";
GRANT ALL ON FUNCTION "public"."reset_database_admin"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."reset_database_admin"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."save_custom_menu_dishes"("p_menu_id" "uuid", "p_dish_ids_to_add" "uuid"[], "p_dish_ids_to_remove" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."save_custom_menu_dishes"("p_menu_id" "uuid", "p_dish_ids_to_add" "uuid"[], "p_dish_ids_to_remove" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."save_custom_menu_dishes"("p_menu_id" "uuid", "p_dish_ids_to_add" "uuid"[], "p_dish_ids_to_remove" "uuid"[]) TO "service_role";
...
with check ((bucket_id = 'dishes'::text));
  ...
  create policy "Allow authenticated delete dishes"
  on "storage"."objects"
  as permissive
  for delete
  to public
using (((bucket_id = 'dishes'::text) AND (auth.role() = 'authenticated'::text)));
  ...
  create policy "Allow authenticated delete logos"
  on "storage"."objects"
  as permissive
  for delete
  to public
using (((bucket_id = 'logos'::text) AND (auth.role() = 'authenticated'::text)));
  ...
  create policy "Allow authenticated update dishes"
  on "storage"."objects"
  as permissive
  for update
  to public
using (((bucket_id = 'dishes'::text) AND (auth.role() = 'authenticated'::text)));
  ...
  create policy "Allow authenticated update logos"
  on "storage"."objects"
  as permissive
  for update
  to public
using (((bucket_id = 'logos'::text) AND (auth.role() = 'authenticated'::text)));
  ...
  create policy "Allow authenticated upload dishes"
  on "storage"."objects"
  as permissive
  for insert
  to public
