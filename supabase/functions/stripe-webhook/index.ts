...
serve(async (req) => {
    ...
    try {
        ...
        // Stripe Billing verso MINTHI e' disattivato; eventuali eventi legacy
        // di invoice/subscription vengono ignorati sotto. Gli eventi Connect
        // (pagamenti clienti, account.updated) restano attivi.
        ...
        switch (event.type) {
            ...
            case "invoice.paid": {
                console.log(`[WEBHOOK] invoice.paid ignorato: billing Stripe MINTHI disattivato.`);
                break;
            }

            case "invoice.payment_failed": {
                console.log(`[WEBHOOK] invoice.payment_failed ignorato: billing Stripe MINTHI disattivato.`);
                break;
            }

            case "customer.subscription.deleted":
            case "customer.subscription.paused": {
                console.log(`[WEBHOOK] ${event.type} ignorato: subscription Stripe MINTHI disattivata.`);
                break;
            }

            case "customer.subscription.updated": {
                console.log(`[WEBHOOK] customer.subscription.updated ignorato: subscription Stripe MINTHI disattivata.`);
                break;
            }
