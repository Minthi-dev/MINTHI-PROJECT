...
export const DEMO_TOUR_STEPS: DemoGuideStep[] = [
  ...
  },
  {
    ...
    tab: 'menu',
    title: 'Menu \u2014 Piatti',
    description: 'Per ogni piatto puoi impostare: nome, prezzo, descrizione, foto, categoria e allergeni (glutine, latte, uova, pesce, ecc. secondo la normativa EU). Puoi rendere un piatto attivo/inattivo senza eliminarlo (utile per piatti stagionali). Se hai il coperto attivo, viene aggiunto automaticamente al conto. Se usi l\'All You Can Eat, puoi segnare quali piatti sono inclusi e impostare un limite ordini per persona.',
