...
export default function LoginPage({ onLogin }: Props) {
  ...
  return (
    <div id="login-container" className="h-[100dvh] flex flex-col items-center justify-center bg-black text-amber-50 p-4 font-sans selection:bg-amber-500/30 overflow-hidden relative fixed inset-0">
